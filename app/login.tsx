...
const cfg: Record<Role, {
  ...
  admin: {
    ...
    gradient: ['#05183A', '#092A5E', '#1C4A94'], accent: '#FF9933', icon: 'shield-account', // KVS Blue + Saffron
  },
  teacher: {
    ...
    gradient: ['#092A5E', '#1C4A94', '#05183A'], accent: '#138808', icon: 'book-education',
  },
  parent: {
    ...
    gradient: ['#1C4A94', '#092A5E', '#FF9933'], accent: '#FF9933', icon: 'account-heart',
  },
  conductor: {
    ...
    gradient: ['#7C3000', '#F59E0B', '#FF9933'], accent: '#FF9933', icon: 'bus-clock',
  },
  bus_driver: {
    title: 'Driver Portal', subtitle: 'Route & Trip Management',
    usernameLabel: 'Bus Number', usernamePh: 'e.g. 1  (for Bus 1)',
    hint: 'Email: driver[N]@kvpattom.edu\nPassword: KVPATTOM_64\nNew? Use Register tab.',
    gradient: ['#064E3B', '#138808', '#059669'], accent: '#10B981', icon: 'steering',
  },
  security: {
    ...
    gradient: ['#7F1D1D', '#DC2626', '#FF9933'], accent: '#EF4444', icon: 'shield-star',
  },
};
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
            <ResponsiveContainer maxWidth={550}>
              ...
              <View style={styles.brandRow}>
                ...
                <View style={{ marginLeft: 12 }}>
                  ...
                  <Text style={styles.brandSub}>PM SHRI Kendriya Vidyalaya Pattom</Text>
                </View>
              </View>
            ...
            {role === 'security' && (
              ...
              <Text style={styles.footer}>Created by Team NovaThink (PM SHRI KV Pattom Shift 2)</Text>
            </ResponsiveContainer>
          </ScrollView>
