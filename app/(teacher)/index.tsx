    ...
    <View style={{ flex: 1, backgroundColor: Colors.background }}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ gap: Spacing.md }}>
          <Pressable onPress={() => router.push('/(teacher)/attendance' as any)}>
            <Card>
              <View style={styles.row}>
          ...
          <Pressable onPress={() => router.push('/(teacher)/exams' as any)}>
            <Card>
              <View style={styles.row}>
          ...
          {isClassTeacher && (
            <Pressable onPress={() => router.push('/(teacher)/analytics' as any)}>
              <Card>
                <View style={styles.row}>
          ...
          <Pressable onPress={() => router.push('/(teacher)/timetable' as any)}>
            <Card>
              <View style={styles.row}>
          ...
          {isClassTeacher && (
            <Pressable onPress={() => router.push('/(teacher)/incidents' as any)}>
              <Card>
                <View style={styles.row}>
        ...
        <View style={styles.dashboardGrid}>
          <Pressable style={styles.dashboardTile} onPress={() => router.push('/(teacher)/students' as any)}>
          ...
          <Pressable style={styles.dashboardTile} onPress={() => router.push('/(teacher)/edit-student' as any)}>
            <View style={[styles.tileIconWrap, { backgroundColor: Colors.successBg }]}>
              <MaterialCommunityIcons name="account-edit" size={28} color={Colors.success} />
            </View>
            <Text style={styles.tileLabel}>Edit Details</Text>
          </Pressable>
          <Pressable style={styles.dashboardTile} onPress={() => router.push('/(teacher)/homework' as any)}>
          ...
          <Pressable style={styles.dashboardTile} onPress={() => router.push('/(teacher)/lesson' as any)}>
          ...
          <Pressable style={styles.dashboardTile} onPress={() => router.push('/(teacher)/diary' as any)}>
            <View style={[styles.tileIconWrap, { backgroundColor: Colors.successBg }]}>
              <MaterialCommunityIcons name="notebook-edit" size={28} color={Colors.success} />
            </View>
            <Text style={styles.tileLabel}>Class Diary</Text>
          </Pressable>
          <Pressable style={styles.dashboardTile} onPress={() => router.push('/(teacher)/ai' as any)}>
          ...
          <Pressable style={styles.dashboardTile} onPress={() => router.push('/(teacher)/profile' as any)}>
          ...
          <Pressable style={styles.dashboardTile} onPress={() => router.push('/(teacher)/special-module' as any)}>
            <View style={[styles.tileIconWrap, { backgroundColor: '#Fefce8' }]}>
